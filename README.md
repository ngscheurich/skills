...
This is my living set of [Agent Skills](https://agentskills.io/home).

## Skills

- **[commit](commit/SKILL.md)** — Write Git commits in house style: Conventional Commits plus the project's prose conventions.
